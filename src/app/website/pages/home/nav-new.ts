...
@Component({
  ...
  template: `
    <nav
      class="relative flex flex-wrap items-center justify-between px-2 py-3 h-20"
    >
      <div
      ...
      >
        ...
        <div
          ...
          class="absolute right-0 top-20 z-10 flex bg-blue_primary-dark_1 h-screen w-1/2 font-semibold text-lg p-3 lg:flex lg:flex-grow md:justify-end lg:text-lg "
        >
          <div class="flex flex-col justify-between">
            <ul
              class="flex flex-col gap-3 list-none  text-white lg:flex-row lg:gap-4 lg:ml-auto  "
            >
              <li>
                <a
                  href="#"
            ...
            <div class="flex gap-3 mb-32 items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="21"
                height="20"
