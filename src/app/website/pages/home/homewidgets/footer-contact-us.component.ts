...
@Component({
  ...
  template: `
    <div class="flex flex-col flex-1 gap-3 ">
      <h2 class=" text-xl app-underline app-underline__footer">Contact Us</h2>
      <div class="inline-flex gap-2">
        <svg
          class="hover:fill-accent active:fill-neutral-100 cursor-pointer transition-colors duration-200"
